...
<body id="printTable">
  ...
  <div class="sidebar">
    ...
    <a href="?page=billingapprovaltravel2" class="logout-link" style = "background-color:#555; color:white;">
  ...
  <table class="table table-striped text-center" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          if ($id3 == '5'){
          $approval_level_id = 33;
          }

          else if ($id3 == '6'){
            $approval_level_id = 37;
          }
...
<div class = "container2">
  ...
  <table>
    ...
    <tr>
      <td class="cell-gap" valign="top">Billing 2 Approval :</td>
  ...
  if (isset($_POST["submit"])) {
        $bil2Approval = $_POST["billing2_approval"];
        $remarks = $_POST["remark"];
      
        if ($bil2Approval == "1") {
          $billing2_status = 'Approved';
        } else if ($bil2Approval == "2") {
          $billing2_status = 'Declined';
        }
        
        //next approval
         $form = $id3;
        $next = check_next_approval($id, $ses_staffno);
        $updateSql = "UPDATE approval_detail SET approval_status = '$billing2_status',approval_remarks = '".$remarks."' WHERE staffno = '$ses_staffno' AND  t_claims_id = $id AND approval_priority = $next";

        if ($billing2_status == "Declined") {
        ...
        $goto = "?page=billingapprovaltravel2";
        $msg = "";
        $func	-> info($msg,$goto);
...
?>
      ...
      <td class="cell-gap" valign="top">
        <select name="billing2_approval" required>
