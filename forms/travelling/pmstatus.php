...
<body id="printTable">
  ...
  <div class="sidebar">
    ...
    <a href="?page=pmapproval" class="logout-link" style = "background-color:#555; color:white;">
...
<div class = "container2">
  Approval Status
    ...
    <form id="approval-PM" action="" method="POST" enctype="multipart/form-data">
  <table>
    ...
    $sql5 = mysqli_query($mysqli, "SELECT * FROM travelclaims2 WHERE travel_id = '".$id."'");
      while ($dql5 = mysqli_fetch_array($sql5)) 
      {
          ...
          $sql6 = "SELECT * FROM approval_detail WHERE t_claims_id = ".$id5." AND staffno = '".$ses_staffno."' AND approval_level_id = 2";
