...
<body id="printTable">
  ...
  <div class="sidebar">
    ...
    <a href="?page=ceoapprovaltravel" class="logout-link" style = "background-color:#555; color:white;">
...
<div class = "container2">
  ...
  if (isset($_POST["submit"])) {
    $ceoApproval = $_POST["ceo_approval"];
    $remarks = $_POST["remark"];
  
    if ($ceoApproval == "1") {
      $ceo_status = 'Approved';
    } else if ($ceoApproval == "2") {
      $ceo_status = 'Declined';
    }
    ...
    $updateSql = "UPDATE approval_detail SET approval_status = '$ceo_status',approval_remarks = '".$remarks."' WHERE staffno = '$ses_staffno' AND  t_claims_id = $id AND approval_priority = $next";

    if ($ceo_status == "Declined") {
