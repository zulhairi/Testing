...
<table class="table  table-striped text-center">
  ...
  <?php
    ...
    $sql = "SELECT * FROM approval_detail WHERE staffno = '".$ses_staffno."' AND approval_status = 'pending' AND approval_level_id = 25";
    ...
    ?>
          <tr class="table-light">
            ...
            <td>
             <a href="?page=billingapprovalstatusotmeal&id=<?php echo $row4["t_claims_id"]; ?>" class="link-dark"><i class="fa-solid fa-eye"></i></a>
            </td>
          </tr>
