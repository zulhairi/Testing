...
<div class="container"
    ...
    <h2>Requested PROJECT MANAGER Advance Listing</h2>
  ...
  <?php
    ...
    $sql = "SELECT * FROM approval_detail WHERE staffno = '".$ses_staffno."' AND approval_status = 'pending' AND approval_level_id = 15";
    ...
    ?>
          <tr class="table-light">
            ...
            <td>
             <a href="?page=pmapprovalstatusadvance&id=<?php echo $row4["t_claims_id"]; ?>" class="link-dark"><i class="fa-solid fa-eye"></i></a>
            </td>
          </tr>
