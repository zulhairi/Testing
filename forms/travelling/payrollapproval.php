...
<h2>Payroll Approval Listing</h2>
...
$sql = "SELECT * FROM approval_detail WHERE staffno = '".$ses_staffno."' AND approval_status = 'pending' AND form_category = 1 AND approval_level_id = 9";
  ...
  $result5 = mysqli_query($mysqli, $sql);
    ...
    ?>
      <tr class="table-light">
        ...
        <td>
         <a href="?page=payrollstatustravel&id=<?php echo $row4["t_claims_id"]; ?>" class="link-dark"><i class="fa-solid fa-eye"></i></a>
        </td>
      </tr>
