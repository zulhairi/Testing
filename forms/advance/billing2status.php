...
$sql5 = mysqli_query($mysqli, "SELECT * FROM advanceclaim WHERE advance_id = '".$id."'");
  ...
  if (isset($_POST["submit"])) {
    $bil2Approval = $_POST["bil2_approval"];
    $remarks = $_POST["remark"];
  
    if ($bil2Approval == "1") {
      $bil2_status = 'Approved';
    } else if ($bil2Approval == "2") {
      $bil2_status = 'Declined';
    }
   ...
   $updateSql = "UPDATE approval_detail SET approval_status = '$bil2_status',approval_remarks = '".$remarks."' WHERE staffno = '$ses_staffno' AND  t_claims_id = $id AND approval_priority = $next";
   

   if ($bil_status == "Declined") {
...
?>
      ...
      <td class="cell-gap" valign="top">
        <select name="bil2_approval" required>
