<style>
    ...
    <table class="table table-striped text-center" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
      <thead class="head">
        <tr style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
          ...
          <th scope="col" style="white-space: nowrap;">C.C (Vehicle)</th>
      ...
      <tbody>
        ...
        // if (logged_in() == 1) {
        //   $form = 5;
        //   $approval_level_id = 32;
          
        // }elseif(logged_in() == 2){
        //   $form = 6;
        //   $approval_level_id = 36;
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          $id3 = $row["form_category"];         
              ...
              //check next approver id
              // check_form_with_multiple_flow($row["form_category"]);

              // echo $approval_level_id;
          ...
          <tr class="table-light">
            ...
            <td colspan="2" style="font-weight: bold;"><br>
              <?php
              $sql2 = "SELECT * FROM approval_detail WHERE  approval_level_id = $approval_level_id AND t_claims_id = " . $id2;
  ...
  <thead class="head">
    <tr>
      <th scope="col" colspan="11" style="text-align: center; white-space: nowrap;">Approval Status</th>
    </tr>
  </thead>
  
  <!-- approval status -->
  <tbody>
    <tr class="table-light" colspan="12" style="text-align: center; white-space: nowrap;">
        ...
        <div style="display: flex; justify-content: flex-start;">
          <form id="approval-HOD" action="" method="POST" enctype="multipart/form-data">
              ...
              <tr style='text-align: center' class="table-light" >
                <td colspan='3' class="cell-gap" valign="top"  style="width: 200px;">
                  ...
                  if (isset($_POST["submit"])) {
                    $billingApproval = $_POST["billing_approval"];
                    $remarks = $_POST["remark"];

                    if ($billingApproval == "1") {
                      $billingStatus = 'Approved';
                    } else if ($billingApproval == "2") {
                    ...
                    $updateSql = "UPDATE approval_detail SET approval_status = '$billingStatus',approval_remarks = '" . $remarks . "' WHERE staffno = '$ses_staffno' AND  t_claims_id = $id AND approval_priority = $next";
                    ...
                    if ($billingStatus == "Declined") {
                      ...
                      if (mysqli_query($mysqli, $updateSql)) {
                        ...
                        <br />";
                          ...
                          if ($ar["imail"] != "") {
                            $mto = $ar["imail"];
                            $subject = "Travelling Form - Next Approval";
                    ...
                    $goto = "?page=billingapprovaltravel";
                    $msg = "";
                    $func->info($msg, $goto);
                  }
                ...
                <td colspan='2' class="cell-gap" valign="top">
                  Approval Status :
                  <hr \>
                  <select name="billing_approval">
                    <option value="">Please Select</option>
                    <option value="1">Approve</option>
                    <option value="2">Decline</option>
                  </select>
                </td>
                <td colspan='4' class="cell-gap" valign="top">
                  Remarks :
                  <hr \>
                  <textarea name="remark" placeholder="Enter remark"></textarea>
                </td>
                <td colspan='3' class="cell-gap" valign="top">
                  Action :
                  <hr \>
