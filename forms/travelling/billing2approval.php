...
<h2>Billing 2 Approval Listing</h2>
...
<!--The data table element ends here-->
  ...
  <?php
      ...
      $sql = "SELECT * FROM approval_detail WHERE staffno = '".$ses_staffno."' AND approval_status = 'pending' AND form_category IN(1,5,6) AND approval_level_id IN(5,33,37)";
        ...
        ?>
            <tr class="table-light">
              ...
              <td>
                ...
                <a href="?page=billingstatustravel2&id=<?php echo  $row4["t_claims_id"]; ?>" class="link-dark"><i class="fa-solid fa-eye"></i></a>
              </td>
            </tr>
