...
<!--The data table element ends here-->
  ...
  if(logged_in() == 1){
    ...
    $approval_level_id = 38;
      ...
      $sql = "SELECT * FROM approval_detail WHERE staffno = '".$ses_staffno."' AND approval_status = 'pending' AND form_category = $form AND approval_level_id =$approval_level_id";
        ...
        ?>
            <tr class="table-light">
              ...
              <td>
                ...
                <a href="?page=ceostatustravel&id=<?php echo  $row4["t_claims_id"]; ?>" class="link-dark"><i class="fa-solid fa-eye"></i></a>
              </td>
            </tr>
