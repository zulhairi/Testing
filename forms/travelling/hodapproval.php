...
<!--The data table element ends here-->
  ...
  <?php
    ...
    $sql = "SELECT * FROM approval_detail WHERE staffno = '".$ses_staffno."' AND  approval_status = 'pending' AND form_category = 1 AND  approval_level_id = 1";
    ...
    ?>
          <tr class="table-light">
            ...
            <td>
             <a href="?page=hodapprovalstatustravel&id=<?php echo $row4["t_claims_id"]; ?>" class="link-dark"><i class="fa-solid fa-eye"></i></a>
            </td>
          </tr>
