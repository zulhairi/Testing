...
<body>
  ...
  <div class="container"
    ...
    <h2>Requested Billing 1 Advance Listing</h2>
    <table class="table table-striped text-center" id="travelClaimsTable">
      ...
      <tbody>
        ...
        $sql = "SELECT * FROM approval_detail WHERE staffno = '" . $ses_staffno . "' AND approval_status = 'pending' AND approval_level_id = 16";
        ...
        while ($row4 = mysqli_fetch_array($result4)) {
          ...
          if (($row4["approval_priority"] < $row5["approval_priority"] && $row5["approval_status"] == "pending") || ($row4["approval_priority"] > $row5["approval_priority"] && $row5["approval_status"] == "Approved")) {
            ...
            <tr class="table-light">
              ...
              <td>
                <?php echo $row2["when_required"] ?>
              </td>
              <td>
                <?php echo $row2["nature"] ?>
              </td>
              <td>
                <?php echo $row2["purpose"] ?>
              </td>
              <td>
                <a href="?page=billing1status&id=<?php echo $row4["t_claims_id"]; ?>" class="link-dark"><i
        ...
        //secondary PIC
        $q = mysqli_query($mysqli, "SELECT * FROM approval_level_secondary WHERE approval_priority = '3' AND form_categories = '3'");
