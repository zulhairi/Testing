...
<body id="printTable">
  ...
  <div class="sidebar">
    ...
    <a href="?page=financeapprovaltravel" class="logout-link" style = "background-color:#555; color:white;">
  ...
  <table class="table table-striped text-center" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
    ...
    <tbody>
        ...
        // if (logged_in() == 1) {
        //   $form = 5;
        //   $approval_level_id = 35;
          
        // }elseif(logged_in() == 2){
        //   $form = 6;
        //   $approval_level_id = 39;
...
<div class = "container2">
  ...
  <table>
    ...
    <tr>
      <td class="cell-gap" valign="top">Finance Approval :</td>
  ...
  if (isset($_POST["submit"])) {
    $accountApproval = $_POST["account_approval"];
    $remarks = $_POST["remark"];
  
    if ($accountApproval == "1") {
      $account_status = 'Approved';
    } else if ($accountApproval == "2") {
    ...
    $updateSql = "UPDATE approval_detail SET approval_status = '$account_status',approval_remarks = '".$remarks."' WHERE staffno = '$ses_staffno' AND  t_claims_id = $id AND approval_priority = $next";
    
    if ($account_status == "Declined") {
      ...
      if (mysqli_query($mysqli, $updateSql)) {
          ...
          if($dql8["approval_priority"] == ""){
            ...
            if($ar["imail"]!=""){
              $mto = $ar["imail"];
              $subject = "Travelling Form - Payroll Approval";
              ...
              'X-Mailer: PHP/' . phpversion();
              if (mail($mto, $subject, $message, $headers)) {
                print "</br>"."Mailed Sent to ".$mto;
              }else{
                print "</br>"."Mail Sent Failed";
              }
            }
          }
      ...
      $goto = "?page=financeapprovaltravel";
      $msg = "";
      $func	-> info($msg,$goto);
}
