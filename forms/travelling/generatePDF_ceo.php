...
<table width="100%" border="0" cellspacing="3" cellpadding="3">
  ...
  <tr>
    <td colspan="2" valign="top"><h2>TRAVELLING FORM - CEO</h2><hr /></td>
  </tr>
  <tr>
...
if ($ur["particular"] === "mileage") {
  ...
  <tr>
    ...
    <td><strong>Mr.Ravi Approval</strong></td>
  ...
  <tr>
    <td><?php
     ...
     while ($dql5 = mysqli_fetch_array($sql5)) 
     {
         ...
         $sql6 = "SELECT * FROM approval_detail WHERE t_claims_id = ".$id5." AND approval_level_id = 32";
    ...
    <td><?php 
     ...
     while ($dql5 = mysqli_fetch_array($sql5)) 
     {
         ...
         $sql6 = "SELECT * FROM approval_detail WHERE t_claims_id = ".$id5." AND approval_level_id = 33";
         $result6 = mysqli_query($mysqli, $sql6);
         $row6 = mysqli_fetch_assoc($result6);
    ...
    <td><?php
     ...
     while ($dql5 = mysqli_fetch_array($sql5)) 
     {
         ...
         $sql6 = "SELECT * FROM approval_detail WHERE t_claims_id = ".$id5." AND approval_level_id = 34";
         $result6 = mysqli_query($mysqli, $sql6);
         $row6 = mysqli_fetch_assoc($result6);
    ...
    <td><?php 
     ...
     while ($dql5 = mysqli_fetch_array($sql5)) 
     {
         ...
         $sql6 = "SELECT * FROM approval_detail WHERE t_claims_id = ".$id5." AND approval_level_id = 35";
         $result6 = mysqli_query($mysqli, $sql6);
         $row6 = mysqli_fetch_assoc($result6);
