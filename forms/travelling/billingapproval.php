...
<h2>Billing 1 Approval Listing</h2>
...
$sql = "SELECT * FROM approval_detail WHERE staffno = '".$ses_staffno."' AND approval_status = 'pending' AND form_category IN(1,5,6) AND approval_level_id IN(4,32,36)";
  ...
  $t_id = $row4["t_claims_id"];
    ...
    ?>
        <tr class="table-light">
          ...
          <td>
            <a href="?page=billingstatustravel&id=<?php echo $row4["t_claims_id"]; ?>" class="link-dark"><i class="fa-solid fa-eye"></i></a>
          </td>
        </tr>
