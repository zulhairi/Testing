...
<h2>Finance Approval Listing</h2>
...
<!--The data table element ends here-->
  ...
  <?php
    ...
    $sql = "SELECT * FROM approval_detail WHERE staffno = '".$ses_staffno."' AND approval_status = 'pending' AND form_category IN(1,5,6) AND approval_level_id IN(8,35,39)";
      ...
      $t_id = $row4["t_claims_id"];
        ...
        ?>
            <tr class="table-light">
              ...
              <td>
                <a href="?page=financestatustravel&id=<?php echo $row4["t_claims_id"]; ?>" class="link-dark"><i class="fa-solid fa-eye"></i></a>
              </td>
            </tr>
