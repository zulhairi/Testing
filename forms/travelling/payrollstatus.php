...
<body id="printTable">
  ...
  <div class="sidebar">
    ...
    <a href="?page=payrollapprovaltravel" class="logout-link" style="background-color:#555; color:white;">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          <tr class="table-light">
            ...
            <td colspan="2" style="font-weight: bold;"><br>
              <?php
              $sql2 = "SELECT * FROM approval_detail WHERE  approval_level_id = 1 AND t_claims_id = " . $id2;
        ...
        <tr>
          <td class="cell-gap" valign="top">
            ...
            if (isset($_POST["submit"])) {
              $payrollApproval = $_POST["payroll_approval"];
              $remarks = $_POST["remark"];

              if ($payrollApproval == "1") {
                $payroll_status = 'Approved';
              } else if ($payrollApproval == "2") {
                $payroll_status = 'Declined';
              }
              ...
              $updateSql = "UPDATE approval_detail SET approval_status = '$payroll_status',approval_remarks = '" . $remarks . "' WHERE staffno = '$ses_staffno' AND  t_claims_id = $id AND approval_priority = $next";

              if ($payrollApproval == "Declined") {
          ...
          <br />";
              ...
              $goto = "?page=payrollapprovaltravel";
              $msg = "";
              $func->info($msg, $goto);
            }
