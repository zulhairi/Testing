<style>
  ...
  .remarks table {
    ...
    .remarks td {
        background-color: white;
        height: 100%;
        width: 5%; /* Set a fixed width (25%) for each table cell */
...
<body id="printTable">
 ...
 <thead class="head">
      ...
      <td scope="col" colspan="12" style="text-align: center; white-space: nowrap;">
                  ...
                  <table style="text-align:center;  margin-left:auto;  margin-right:auto; ">
                    ...
                    while ($sq = mysqli_fetch_array($sl)) {
                      ...
                      if ($sq["approval_level_id"] == 1) {
                        //HOD  
                        $hod_status = $sq["approval_status"];
                        $hod_remarks = $sq["approval_remarks"];
                      }

                      elseif ($sq["approval_level_id"] == 2) {
                        //Project Manager
                        $pm_status = $sq["approval_status"];
                        $pm_remarks = $sq["approval_remarks"];
                      }

                      elseif ($sq["approval_level_id"] == 4) {
                        //Billing(1)
                        $billing_status = $sq["approval_status"];
                        $billing_remarks = $sq["approval_remarks"];

                      }
                      elseif ($sq["approval_level_id"] == 5) {
                        //Billing(2)
                        $billing2_status = $sq["approval_status"];
                        $billing2_remarks = $sq["approval_remarks"];
                      }

                      elseif ($sq["approval_level_id"] == 8) {
                        //Billing(2)
                        $finance_status = $sq["approval_status"];
                        $acc_remarks = $sq["approval_remarks"];
                      }

                      elseif ($sq["approval_level_id"] == 9) {
                        //Billing(2)
                        $payroll_status = $sq["approval_status"];
                        $payroll_remarks = $sq["approval_remarks"];
                      }
                    ...
                    <td class="cell-gap" valign="top">Project Manager Approval : <br><strong>
                            <?php 
                            if ($pm_status == "Approved") {
                            print "<span class='button-3' role='button'>Approved</button>";
                            } else if ($pm_status == "Declined") {
                              print "<span class='button-4' role='button'>Declined</button>";
                            } else {
                              print "<span class='button-2' role='button'>Pending</button>";
                      ...
                      <td class="cell-gap" valign="top">Billing(1) Approval : <br><strong>
                            ...
                            print "<span class='button-3' role='button'>Approved</button>";
                            } else if ($billing_status == "Declined") {
                              print "<span class='button-4' role='button'>Declined</button>";
                            } else {
                              print "<span class='button-2' role='button'>Pending</button>";
                      ...
                      <td class="cell-gap" valign="top">Finance Approval: <br><strong>
                          ...
                          if ($finance_status == "Approved") {
                            print "<span class='button-3' role='button'>Approved</button>";
                          } else if ($finance_status == "Declined") {
                            print "<span class='button-4' role='button'>Declined</button>";
                          } else {
                            print "<span class='button-2' role='button'>Pending</button>";
                      ...
                      <td class="cell-gap" valign="top">Payroll Approval: <br><strong>
                        ...
                        if ($payroll_status == "Approved") {
                          print "<span class='button-3' role='button'>Approved</button>";
                        } else if ($payroll_status == "Declined") {
                          print "<span class='button-4' role='button'>Declined</button>";
                        } else {
                          print "<span class='button-2' role='button'>Pending</button>";
                        }
      ...
      <tr class="table-light" >
        <td scope="col" colspan="12" style="text-align: center; white-space: nowrap;">
            ...
            <div colspan = "3" class="remarks table">
              <?php
              $remarks = array(
                  '<strong> HOD remarks: <br></strong>' . $hod_remarks,
                  '<strong> Project Manager remarks: <br></strong>' . $pm_remarks,
                  '<strong> Billing (1) remarks: <br></strong>' . $bil1_remarks,
                  '<strong> Billing (2) remarks: <br></strong>' . $bil2_remarks,
                  '<strong> Finance remarks: <br></strong>' . $cso_remarks,
                  '<strong> Payroll remarks: <br></strong>' . $acc_remarks
              );
              ?>
    ...
    <!-- Convert PDF Start -->
    <?php
      if ($hod_status === 'Approved' &&  $pm_status === 'Approved' && $billing_status === 'Approved' && $billing2_status === 'Approved' && $finance_status === 'Approved' && $payroll_status === 'Approved' ) {
    ?>
    ...
    <tr class="table-light" >
        <td scope="col" colspan="12" style="text-align: center; white-space: nowrap;">
              <table>
                  ...
                  <a href="?page=generatePDF&id=<?php echo $id; ?>&traveldetails_id=<?php echo $traveldetails; ?>"
                    class="link-dark">
