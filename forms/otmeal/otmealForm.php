   ...
   if(isset($_POST["submit"]))
   {
    ...
    $hod = $_POST["HodApprover"];
     ...
     ");
       ...
       $targetDir = "forms/otmeal/uploads/ ".$ses_staffno."/";
        ...
        <form id="travelling-form" name="borang" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="cloned-container" id="cloned-container">
                    ...
                    <input type="text" id="project" placeholder="Please input project code" oninput="validateInput()" name="project[]" rows="3" required />
                      ...
                      <div class="form-group">
                            ...
                            <input type="number" class="totalOT" id="totalOT_1" min = "2.5"  name="totalOT[]" step="0.01" readonly />
                          </div>
                          <div class="form-group">
                            <label for="amount">Amount (RM):</label>
                            <input type="number" class="amount" id="amount"  min = "5.5" max = "10" name="amount[]" step="0.01"  />
                          </div>
                      </div>
                      <br>
                      <div class="form-group">
          ...
          <div id="form-buttons-container">
                ...
                <div class="total-container">
                    Total Claim (RM): <input type="text" id="totals" name="totals" value="0" style = "width: 100px;">
                </div>
          </div>
        </form>
    </div>
