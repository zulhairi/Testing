  ...
  <div class="below-container">
    <form id="approval-HOD" action="" method="POST" enctype="multipart/form-data">
      <table>
        ...
        <tr>
          <td class="cell-gap" valign="top">Billing Approval :</td>
        ...
        <tr>
          <td class="cell-gap" valign="top">
            ...
            if (isset($_POST["submit"])) {
              $bilApproval = $_POST["bil_approval"];
              $remarks = $_POST["remark"];

              if ($bilApproval == "1") {
                $bil_status = 'Approved';
              } else if ($bilApproval == "2") {
                $bil_status = 'Declined';
              }
              ...
              $updateSql = "UPDATE approval_detail SET approval_status = '$bil_status',approval_remarks = '" . $remarks . "' WHERE staffno = '$ses_staffno' AND  t_claims_id = $id AND approval_priority = $next";
        ...
        <br />";
          ...
          <td class="cell-gap" valign="top">
            <select name="bil_approval" required>
