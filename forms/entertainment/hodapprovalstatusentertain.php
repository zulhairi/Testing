...
<div class="container" style="margin-left:270px;  background-color:white; padding-top:20px; border-radius:20px; box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px; ">
...
<table class="table table-striped text-center" id="travelClaimsTable">    <thead class="head">
      <tr style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
        <th scope="col" colspan="3" style="white-space: nowrap;">Name</th>
        <th scope="col" colspan="1" style="white-space: nowrap;">Position</th>
        <th scope="col" colspan="1" style="white-space: nowrap;">Staff No</th>
  ...
  $sql = "SELECT * FROM entertainmentclaim WHERE entertainment_claim = '".$id."'";
          ...
          while ($row = mysqli_fetch_assoc($result)) 
          {
            ...
            <td colspan="3" style = "font-weight: bold;"><br><?php echo $row["name"]?></td>
            <td colspan="1" style = "font-weight: bold;"><br><?php echo $row["position"]?></td>
            <td colspan="1" style = "font-weight: bold;"><br><?php echo $row["staffno"]?> </td>
...
$sql5 = mysqli_query($mysqli, "SELECT * FROM entertainmentclaim WHERE entertainment_claim = '".$id."'");
  ...
  if (isset($_POST["submit"])) {
        ...
        if (mysqli_query($mysqli, $updateSql)) {
            ...
            if($dql8["approval_priority"] == ""){
              ...
              if($ar["imail"]!=""){
                ...
                $message = "Dear ".recap($ar["name"]).",<br /><br />You Have New Entertainment Approval Pending
    ...
    $goto = "?page=hodapprovalentertain";
    $msg = "";
    $func	-> info($msg,$goto);
