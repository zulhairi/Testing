    ...
    ?>
          <tr class="table-light">
            <td class="counterCell"></td>
              ...
              <?php 
                $sql2 = "SELECT * FROM test_details WHERE aclaims_id =".$row4["t_claims_id"];
            ...
            <td>
             <a href="?page=hodapprovalstatus&id=<?php echo $row4["t_claims_id"]; ?>" class="link-dark"><i class="fa-solid fa-eye"></i></a>
            </td>
          </tr>
